...
Run: python scripts/discover-boards.py --domains se.com,hcf.com.au [--json out.json]
     python scripts/discover-boards.py --urls https://careers.example.com/
"""
...
def sweep(domain: str) -> dict:
    ...
    for url in candidates(domain):
        ...
        tried.append(row)
    return {'domain': domain, 'tried': tried, 'found': found, 'followed': followed}
