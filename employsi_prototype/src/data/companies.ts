...
export const COMPANIES: Company[] = [
  { id: 'rio', ticker: 'RIO', name: 'Rio Tinto', sector: 'Iron Ore & Metals', headcount: 11500, growth: 4.1, openRoles: 268, salary: '$152,000', salaryShort: '$152K', salaryNum: 152000, turnover: 9.8, salaryDelta: '+13%', metroDelta: '+13% vs metro', trend: [92, 93, 94, 95, 96, 97, 99, 100], timeToFill: '52 days', competition: 'High', skills: ['Geoscience', 'Process Engineering', 'Remote Operations', 'Rail Systems', 'Decarbonisation'], roles: [{ title: 'Engineering', count: 57 }, { title: 'Geoscience', count: 39 }, { title: 'Rail & Logistics', count: 33 }] },
  { id: 'bhp', ticker: 'BHP', name: 'BHP', sector: 'Diversified Mining', headcount: 9200, growth: 6.4, openRoles: 312, salary: '$148,000', salaryShort: '$148K', salaryNum: 148000, turnover: 11.2, salaryDelta: '+10%', metroDelta: '+10% vs metro', trend: [86, 88, 89, 91, 93, 95, 98, 100], timeToFill: '47 days', competition: 'High', skills: ['Mining Engineering', 'Autonomous Haulage', 'Data Analytics', 'HSE', 'Maintenance Planning'], roles: [{ title: 'Maintenance & Trades', count: 84 }, { title: 'Engineering', count: 61 }, { title: 'Operations', count: 48 }] },
  { id: 's32', ticker: 'S32', name: 'South32', sector: 'Metals & Mining', headcount: 3400, growth: 2.0, openRoles: 124, salary: '$141,000', salaryShort: '$141K', salaryNum: 141000, turnover: 12.5, salaryDelta: '+4%', metroDelta: '+4% vs metro', trend: [95, 96, 96, 97, 98, 98, 99, 100], timeToFill: '44 days', competition: 'Medium', skills: ['Metallurgy', 'Supply Chain', 'Sustainability', 'Finance', 'Maintenance'], roles: [{ title: 'Metallurgy & Processing', count: 31 }, { title: 'Maintenance', count: 27 }, { title: 'Corporate', count: 22 }] },
  { id: 'fmg', ticker: 'FMG', name: 'Fortescue', sector: 'Iron Ore & Green Energy', headcount: 7800, growth: 12.3, openRoles: 415, salary: '$139,000', salaryShort: '$139K', salaryNum: 139000, turnover: 14.6, salaryDelta: '+3%', metroDelta: '+3% vs metro', trend: [70, 74, 79, 83, 87, 92, 96, 100], timeToFill: '39 days', competition: 'Very high', skills: ['Renewable Energy', 'Hydrogen', 'Electrical Engineering', 'Project Delivery', 'Automation'], roles: [{ title: 'Renewables & Electrical', count: 96 }, { title: 'Project Delivery', count: 71 }, { title: 'Operations', count: 58 }] },
  { id: 'wds', ticker: 'WDS', name: 'Woodside Energy', sector: 'Oil, Gas & LNG', headcount: 3900, growth: 5.2, openRoles: 201, salary: '$158,000', salaryShort: '$158K', salaryNum: 158000, turnover: 8.4, salaryDelta: '+18%', metroDelta: '+18% vs metro', trend: [88, 90, 91, 93, 95, 96, 98, 100], timeToFill: '50 days', competition: 'High', skills: ['Subsea Engineering', 'LNG Processing', 'Reservoir Engineering', 'Carbon Capture', 'Project Controls'], roles: [{ title: 'Subsurface & Reservoir', count: 48 }, { title: 'Project Delivery', count: 41 }, { title: 'Operations', count: 34 }] },
  { id: 'sto', ticker: 'STO', name: 'Santos', sector: 'Oil & Gas', headcount: 1400, growth: 3.3, openRoles: 88, salary: '$149,000', salaryShort: '$149K', salaryNum: 149000, turnover: 10.1, salaryDelta: '+11%', metroDelta: '+11% vs metro', trend: [93, 94, 95, 96, 97, 98, 99, 100], timeToFill: '46 days', competition: 'Medium', skills: ['Petroleum Engineering', 'Facilities Engineering', 'HSE', 'Commercial', 'Drilling'], roles: [{ title: 'Facilities Engineering', count: 24 }, { title: 'Commercial & Trading', count: 19 }, { title: 'Operations', count: 17 }] },
  { id: 'sfr', ticker: 'SFR', name: 'Sandfire Resources', sector: 'Copper & Base Metals', headcount: 1050, growth: 3.8, openRoles: 62, salary: '$137,000', salaryShort: '$137K', salaryNum: 137000, turnover: 11.0, salaryDelta: '+2%', metroDelta: '+2% vs metro', trend: [97, 98, 98, 99, 99, 99, 100, 100], timeToFill: '45 days', competition: 'Medium', skills: ['Copper Processing', 'Mine Geology', 'Metallurgy', 'Maintenance', 'Environmental'], roles: [{ title: 'Processing & Metallurgy', count: 21 }, { title: 'Maintenance', count: 18 }, { title: 'Geology', count: 13 }] },
  { id: 'igo', ticker: 'IGO', name: 'IGO', sector: 'Battery Metals — Nickel & Lithium', headcount: 920, growth: 7.5, openRoles: 81, salary: '$145,000', salaryShort: '$145K', salaryNum: 145000, turnover: 12.8, salaryDelta: '+7%', metroDelta: '+7% vs metro', trend: [84, 87, 90, 92, 94, 96, 98, 100], timeToFill: '41 days', competition: 'High', skills: ['Battery Metals', 'Lithium Processing', 'Hydromet', 'Data Science', 'Sustainability'], roles: [{ title: 'Processing & Hydromet', count: 26 }, { title: 'Exploration', count: 21 }, { title: 'Corporate & ESG', count: 18 }] },
];
