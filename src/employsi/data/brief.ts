...
export const BRIEF_ARTICLES: BriefArticle[] = [
  {
    ...
    summary:
      "New electrolyser capacity and a wave of electrical and project-delivery hiring underpin the decarbonisation push.",
    tags: ["FMG"],
    tone: "#159d67",
    icon: "energy",
  },
  {
    ...
    summary:
      "Both miners lift investment in remote operations, shifting demand toward data, controls and maintenance roles.",
    tags: ["BHP", "RIO"],
    tone: "#3a3f4a",
    icon: "mine",
  },
  {
    ...
    summary:
      "Long-term offtake supports sustained subsea and reservoir engineering recruitment across the portfolio.",
    tags: ["WDS"],
    tone: "#2b6cb0",
    icon: "gas",
  },
  {
    ...
    summary:
      "Hydromet expansion and processing hires track the battery-metals cycle as nickel and lithium volumes climb.",
    tags: ["IGO"],
    tone: "#0d9488",
    icon: "battery",
  },
  {
    ...
    summary:
      "Higher throughput brings a steady pipeline of metallurgy, processing and maintenance vacancies.",
    tags: ["S32"],
    tone: "#b7791f",
    icon: "metal",
  },
  {
    ...
    summary:
      "CCS milestones widen demand for facilities engineering and commercial talent across the gas business.",
    tags: ["STO"],
    tone: "#6d5bd0",
    icon: "carbon",
  },
