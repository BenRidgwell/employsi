...
export const COMPANIES: Company[] = [
  {
    ...
    turnover: 9.8,
    salaryDelta: "+13%",
    metroDelta: "+13% vs metro",
    trend: [92, 93, 94, 95, 96, 97, 99, 100],
    revPerEmp: 1.01,
    ebitdaPerEmp: 0.44,
    timeToFill: "52 days",
    competition: "High",
    ...
    roles: [
      { title: "Engineering", count: 57 },
      { title: "Geoscience", count: 39 },
      { title: "Rail & Logistics", count: 33 },
    ],
  },
  ...
  // summary bar, which is scoped per-city, not group-wide).
  {
    ...
    turnover: 11.2,
    salaryDelta: "+10%",
    metroDelta: "+10% vs metro",
    trend: [86, 88, 89, 91, 93, 95, 98, 100],
    revPerEmp: 0.62,
    ebitdaPerEmp: 0.32,
    timeToFill: "47 days",
    competition: "High",
    ...
    roles: [
      { title: "Maintenance & Trades", count: 84 },
      { title: "Engineering", count: 61 },
      { title: "Operations", count: 48 },
    ],
  },
  {
    id: "s32",
    ...
    turnover: 12.5,
    salaryDelta: "+4%",
    metroDelta: "+4% vs metro",
    trend: [95, 96, 96, 97, 98, 98, 99, 100],
    revPerEmp: 0.43,
    ebitdaPerEmp: 0.14,
    timeToFill: "44 days",
    competition: "Medium",
    skills: ["Metallurgy", "Supply Chain", "Sustainability", "Finance", "Maintenance"],
    roles: [
      { title: "Metallurgy & Processing", count: 31 },
      { title: "Maintenance", count: 27 },
  ...
  },
  {
    ...
    turnover: 14.6,
    salaryDelta: "+3%",
    metroDelta: "+3% vs metro",
    trend: [70, 74, 79, 83, 87, 92, 96, 100],
    revPerEmp: 1.33,
    ebitdaPerEmp: 0.78,
    timeToFill: "39 days",
    ...
    roles: [
      { title: "Renewables & Electrical", count: 96 },
      { title: "Project Delivery", count: 71 },
      { title: "Operations", count: 58 },
    ],
  },
  {
    id: "wds",
    ...
    turnover: 8.4,
    salaryDelta: "+18%",
    metroDelta: "+18% vs metro",
    trend: [88, 90, 91, 93, 95, 96, 98, 100],
    revPerEmp: 3.05,
    ebitdaPerEmp: 1.46,
    timeToFill: "50 days",
    competition: "High",
    ...
    roles: [
      { title: "Subsurface & Reservoir", count: 48 },
      { title: "Project Delivery", count: 41 },
      { title: "Operations", count: 34 },
    ],
  },
  {
    id: "sto",
    ...
    turnover: 10.1,
    salaryDelta: "+11%",
    metroDelta: "+11% vs metro",
    trend: [93, 94, 95, 96, 97, 98, 99, 100],
    revPerEmp: 2.18,
    ebitdaPerEmp: 0.9,
    timeToFill: "46 days",
    competition: "Medium",
    skills: ["Petroleum Engineering", "Facilities Engineering", "HSE", "Commercial", "Drilling"],
    roles: [
      { title: "Facilities Engineering", count: 24 },
      { title: "Commercial & Trading", count: 19 },
      { title: "Operations", count: 17 },
    ],
  },
  {
    id: "sfr",
    ...
    turnover: 11.0,
    salaryDelta: "+2%",
    metroDelta: "+2% vs metro",
    trend: [97, 98, 98, 99, 99, 99, 100, 100],
    revPerEmp: 1.28,
    ebitdaPerEmp: 0.48,
    timeToFill: "45 days",
    competition: "Medium",
    skills: ["Copper Processing", "Mine Geology", "Metallurgy", "Maintenance", "Environmental"],
    roles: [
      { title: "Processing & Metallurgy", count: 21 },
      { title: "Maintenance", count: 18 },
      { title: "Geology", count: 13 },
    ],
  },
  {
    id: "igo",
    ...
    turnover: 12.8,
    salaryDelta: "+7%",
    metroDelta: "+7% vs metro",
    trend: [84, 87, 90, 92, 94, 96, 98, 100],
    revPerEmp: 1.61,
    ebitdaPerEmp: 0.71,
    timeToFill: "41 days",
    competition: "High",
    skills: ["Battery Metals", "Lithium Processing", "Hydromet", "Data Science", "Sustainability"],
    roles: [
      { title: "Processing & Hydromet", count: 26 },
      { title: "Exploration", count: 21 },
      { title: "Corporate & ESG", count: 18 },
    ],
  },
  {
    id: "min",
    ...
    turnover: 13.2,
    salaryDelta: "+8%",
    metroDelta: "+8% vs metro",
    trend: [80, 84, 88, 90, 93, 96, 98, 100],
    revPerEmp: 1.35,
    ebitdaPerEmp: 0.42,
    timeToFill: "40 days",
    competition: "Very high",
    skills: ["Crushing & Processing", "Lithium", "Heavy Diesel", "Drilling", "Automation"],
    roles: [
      { title: "Maintenance & Trades", count: 88 },
      { title: "Processing", count: 62 },
      { title: "Operations", count: 44 },
    ],
  },
  {
    id: "pls",
    ...
    turnover: 12.0,
    salaryDelta: "+12%",
    metroDelta: "+12% vs metro",
    trend: [72, 78, 83, 88, 92, 95, 98, 100],
    revPerEmp: 1.72,
    ebitdaPerEmp: 0.88,
    timeToFill: "42 days",
    competition: "Very high",
    skills: ["Lithium Processing", "Metallurgy", "Battery Metals", "Maintenance", "Sustainability"],
    roles: [
      { title: "Processing & Metallurgy", count: 34 },
      { title: "Maintenance", count: 28 },
      { title: "Operations", count: 22 },
    ],
  },
  {
    id: "ltr",
    ...
    turnover: 13.8,
    salaryDelta: "+9%",
    metroDelta: "+9% vs metro",
    trend: [55, 64, 72, 80, 86, 92, 97, 100],
    revPerEmp: 1.28,
    ebitdaPerEmp: 0.55,
    timeToFill: "44 days",
    competition: "Very high",
    skills: ["Lithium Processing", "Project Delivery", "Mine Geology", "Metallurgy", "Automation"],
    roles: [
      { title: "Project Delivery", count: 31 },
      { title: "Processing", count: 24 },
      { title: "Geology", count: 19 },
    ],
  },
  {
    id: "ilu",
    ...
    turnover: 10.6,
    salaryDelta: "+5%",
    metroDelta: "+5% vs metro",
    trend: [90, 91, 93, 94, 96, 97, 99, 100],
    revPerEmp: 1.44,
    ebitdaPerEmp: 0.61,
    timeToFill: "46 days",
    competition: "Medium",
    ...
    roles: [
      { title: "Processing & Refining", count: 27 },
      { title: "Engineering", count: 22 },
      { title: "Environmental", count: 16 },
    ],
  },
  {
    id: "nst",
    ...
    salaryDelta: "+7%",
    metroDelta: "+7% vs metro",
    trend: [85, 88, 90, 92, 94, 96, 98, 100],
    revPerEmp: 0.95,
    ebitdaPerEmp: 0.44,
    timeToFill: "43 days",
    competition: "High",
    skills: ["Underground Mining", "Metallurgy", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Underground Mining", count: 74 },
      { title: "Processing", count: 52 },
      { title: "Geology", count: 38 },
    ],
  },
  {
    id: "chevron",
    ...
    roles: [
      { title: "Operations", count: 56 },
      { title: "Project Delivery", count: 44 },
      { title: "Subsurface", count: 32 },
    ],
  },
  {
    id: "beach",
    ...
    salaryDelta: "+12%",
    metroDelta: "+12% vs metro",
    trend: [88, 90, 92, 93, 95, 97, 98, 100],
    revPerEmp: 2.1,
    ebitdaPerEmp: 1.05,
    timeToFill: "48 days",
    competition: "High",
    ...
    roles: [
      { title: "Subsurface", count: 32 },
      { title: "Facilities", count: 26 },
      { title: "Operations", count: 18 },
    ],
  },
  {
    id: "mgt",
    ...
    salaryDelta: "+4%",
    metroDelta: "+4% vs metro",
    trend: [70, 76, 82, 86, 90, 94, 97, 100],
    revPerEmp: 0.9,
    ebitdaPerEmp: 0.3,
    timeToFill: "42 days",
    competition: "High",
    skills: ["Magnetite Processing", "Metallurgy", "Project Delivery", "Environmental", "Studies"],
    roles: [
      { title: "Project Delivery", count: 10 },
      { title: "Metallurgy", count: 7 },
      { title: "Environmental", count: 5 },
    ],
  },
  {
    id: "hgo",
    ...
    salaryDelta: "+5%",
    metroDelta: "+5% vs metro",
    trend: [64, 72, 80, 86, 91, 95, 98, 100],
    revPerEmp: 1.1,
    ebitdaPerEmp: 0.42,
    timeToFill: "44 days",
    competition: "High",
    skills: ["Underground Mining", "Copper Processing", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Underground Mining", count: 15 },
      { title: "Processing", count: 11 },
      { title: "Geology", count: 8 },
    ],
  },
  {
    id: "smr",
    ...
    turnover: 12.2,
    salaryDelta: "+6%",
    metroDelta: "+6% vs metro",
    trend: [86, 88, 90, 92, 94, 96, 98, 100],
    revPerEmp: 1.5,
    ebitdaPerEmp: 0.68,
    timeToFill: "43 days",
    competition: "High",
    skills: ["Coal Mining", "Maintenance", "Processing", "Geology", "HSE"],
    roles: [
      { title: "Operations", count: 52 },
      { title: "Maintenance", count: 40 },
      { title: "Geology", count: 24 },
    ],
  },
  {
    id: "nhc",
    ...
    timeToFill: "45 days",
    competition: "Medium",
    skills: ["Coal Mining", "Rehabilitation", "Maintenance", "Processing", "Environmental"],
    roles: [
      { title: "Operations", count: 34 },
      { title: "Maintenance", count: 28 },
      { title: "Environmental", count: 18 },
    ],
  },
  {
    id: "shell",
    ...
    turnover: 8.6,
    salaryDelta: "+19%",
    metroDelta: "+19% vs metro",
    trend: [94, 95, 96, 97, 98, 99, 99, 100],
    revPerEmp: 3.4,
    ebitdaPerEmp: 1.55,
    timeToFill: "52 days",
    competition: "High",
    skills: ["LNG Processing", "Subsurface", "Project Controls", "HSE", "Commercial"],
    roles: [
      { title: "Operations", count: 58 },
      { title: "Project Delivery", count: 46 },
      { title: "Commercial", count: 30 },
    ],
  },
  {
    id: "aow",
    ...
    salaryDelta: "+12%",
    metroDelta: "+12% vs metro",
    trend: [82, 86, 89, 92, 94, 96, 98, 100],
    revPerEmp: 2.2,
    ebitdaPerEmp: 1.02,
    timeToFill: "47 days",
    competition: "High",
    skills: ["Coal Seam Gas", "Drilling", "Facilities Engineering", "Reservoir Engineering", "HSE"],
    roles: [
      { title: "Subsurface", count: 30 },
      { title: "Facilities", count: 26 },
      { title: "Operations", count: 20 },
    ],
  },
  {
    id: "mmi",
    ...
    salaryDelta: "+3%",
    metroDelta: "+3% vs metro",
    trend: [66, 74, 81, 87, 91, 95, 98, 100],
    revPerEmp: 1.2,
    ebitdaPerEmp: 0.44,
    timeToFill: "42 days",
    competition: "High",
    skills: ["Bauxite Mining", "Barging & Logistics", "Maintenance", "Environmental", "HSE"],
    roles: [
      { title: "Operations", count: 18 },
      { title: "Logistics", count: 13 },
      { title: "Maintenance", count: 9 },
    ],
  },
  {
    id: "jellinbah",
    ticker: "JEL",
    name: "Jellinbah Group",
    domain: "jellinbah.com.au",
    sector: "Coal",
    headcount: 800,
    growth: 4.2,
    openRoles: 48,
    ...
    timeToFill: "44 days",
    competition: "Medium",
    skills: ["Coal Mining", "Maintenance", "Processing", "Rail & Logistics", "HSE"],
    roles: [
      { title: "Operations", count: 20 },
      { title: "Maintenance", count: 16 },
      { title: "Logistics", count: 12 },
    ],
  },
  ...
  // applied to BHP/Rio (share ranges + live news). ──
  {
    ...
    salaryDelta: "+8%",
    metroDelta: "+8% vs metro",
    trend: [70, 76, 82, 87, 91, 95, 98, 100],
    revPerEmp: 0.9,
    ebitdaPerEmp: 0.36,
    timeToFill: "44 days",
    competition: "High",
    skills: ["Uranium Processing", "Metallurgy", "Radiation Safety", "Maintenance", "HSE"],
    roles: [
      { title: "Processing", count: 16 },
      { title: "Maintenance", count: 12 },
      { title: "HSE", count: 8 },
    ],
  },
  {
    ...
    salaryDelta: "+6%",
    metroDelta: "+6% vs metro",
    trend: [80, 84, 88, 91, 94, 96, 98, 100],
    revPerEmp: 0.62,
    ebitdaPerEmp: 0.22,
    timeToFill: "41 days",
    competition: "High",
    skills: ["Underground Mining", "Gold Processing", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Underground Mining", count: 40 },
      { title: "Processing", count: 28 },
      { title: "Geology", count: 18 },
    ],
  },
  {
    id: "stx",
    ...
    timeToFill: "46 days",
    competition: "High",
    skills: ["Reservoir Engineering", "Drilling", "Gas Processing", "Commercial", "HSE"],
    roles: [
      { title: "Subsurface", count: 12 },
      { title: "Commercial", count: 8 },
      { title: "Operations", count: 6 },
    ],
  },
  {
    id: "alk",
    ...
    salaryDelta: "+5%",
    metroDelta: "+5% vs metro",
    trend: [78, 82, 86, 90, 93, 96, 98, 100],
    revPerEmp: 0.8,
    ebitdaPerEmp: 0.3,
    timeToFill: "43 days",
    competition: "Medium",
    skills: ["Gold Processing", "Geology", "Metallurgy", "Maintenance", "Environmental"],
    roles: [
      { title: "Processing", count: 12 },
      { title: "Geology", count: 10 },
      { title: "Maintenance", count: 7 },
    ],
  },
  {
    id: "rrl",
    ...
    timeToFill: "42 days",
    competition: "High",
    skills: ["Open Pit Mining", "Gold Processing", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Mining", count: 34 },
      { title: "Processing", count: 24 },
      { title: "Geology", count: 16 },
    ],
  },
  {
    id: "pru",
    ...
    salaryDelta: "+7%",
    metroDelta: "+7% vs metro",
    trend: [82, 86, 89, 92, 95, 97, 99, 100],
    revPerEmp: 0.68,
    ebitdaPerEmp: 0.3,
    timeToFill: "45 days",
    competition: "High",
    skills: ["Gold Processing", "West Africa Operations", "Geology", "Metallurgy", "HSE"],
    roles: [
      { title: "Operations", count: 44 },
      { title: "Processing", count: 32 },
      { title: "Geology", count: 22 },
    ],
  },
  {
    id: "rms",
    ...
    domain: "rameliusresources.com.au",
    sector: "Gold",
    headcount: 1050,
    growth: 6.8,
    openRoles: 82,
    ...
    salaryDelta: "+6%",
    metroDelta: "+6% vs metro",
    trend: [83, 86, 89, 92, 94, 97, 99, 100],
    revPerEmp: 0.72,
    ebitdaPerEmp: 0.31,
    timeToFill: "42 days",
    competition: "High",
    skills: ["Underground Mining", "Gold Processing", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Mining", count: 28 },
      { title: "Processing", count: 20 },
      { title: "Geology", count: 14 },
    ],
  },
  {
    id: "gmd",
    ...
    salaryDelta: "+7%",
    metroDelta: "+7% vs metro",
    trend: [72, 78, 84, 89, 92, 96, 98, 100],
    revPerEmp: 0.66,
    ebitdaPerEmp: 0.27,
    timeToFill: "43 days",
    competition: "High",
    skills: ["Underground Mining", "Gold Processing", "Geology", "Maintenance", "HSE"],
    roles: [
      { title: "Mining", count: 24 },
      { title: "Processing", count: 18 },
      { title: "Geology", count: 12 },
    ],
  },
  {
    id: "gor",
    ...
    timeToFill: "43 days",
    competition: "Medium",
    skills: ["Open Pit Mining", "Gold Processing", "Geology", "Exploration", "HSE"],
    roles: [
      { title: "Operations", count: 16 },
      { title: "Exploration", count: 12 },
      { title: "Processing", count: 9 },
    ],
  },
  {
    id: "cmm",
    ...
    salaryDelta: "+6%",
    metroDelta: "+6% vs metro",
    trend: [74, 80, 85, 89, 93, 96, 98, 100],
    revPerEmp: 0.86,
    ebitdaPerEmp: 0.4,
    timeToFill: "42 days",
    competition: "High",
    skills: ["Open Pit Mining", "Gold Processing", "Geology", "Project Delivery", "HSE"],
    roles: [
      { title: "Mining", count: 16 },
      { title: "Processing", count: 12 },
      { title: "Project Delivery", count: 9 },
    ],
  },
  {
    id: "dyl",
    ...
    timeToFill: "45 days",
    competition: "High",
    skills: ["Uranium Processing", "Project Delivery", "Geology", "Metallurgy", "Studies"],
    roles: [
      { title: "Project Delivery", count: 12 },
      { title: "Geology", count: 8 },
      { title: "Studies", count: 6 },
    ],
  },
  {
    id: "bmn",
    ...
    salaryDelta: "+7%",
    metroDelta: "+7% vs metro",
    trend: [60, 69, 77, 84, 90, 94, 98, 100],
    revPerEmp: 0.35,
    ebitdaPerEmp: 0.12,
    timeToFill: "46 days",
    competition: "High",
    skills: ["Uranium Processing", "Project Delivery", "Metallurgy", "Studies", "HSE"],
    roles: [
      { title: "Project Delivery", count: 10 },
      { title: "Metallurgy", count: 7 },
      { title: "Studies", count: 5 },
    ],
  },
  {
    id: "boe",
    ...
    salaryDelta: "+8%",
    metroDelta: "+8% vs metro",
    trend: [66, 74, 82, 88, 92, 96, 98, 100],
    revPerEmp: 0.7,
    ebitdaPerEmp: 0.28,
    timeToFill: "44 days",
    competition: "High",
    skills: ["Uranium Processing", "Hydromet", "Metallurgy", "Maintenance", "HSE"],
    roles: [
      { title: "Processing", count: 14 },
  ...
  },
  {
    id: "cvn",
    ticker: "CVN",
    name: "Carnarvon Energy",
    domain: "carnarvon.com.au",
    sector: "Oil & Gas",
    headcount: 90,
    growth: 5.5,
    openRoles: 18,
    ...
    salaryDelta: "+10%",
    metroDelta: "+10% vs metro",
    trend: [82, 85, 88, 91, 94, 96, 98, 100],
    revPerEmp: 0.6,
    ebitdaPerEmp: 0.22,
    timeToFill: "47 days",
    competition: "Medium",
    skills: ["Reservoir Engineering", "Subsurface", "Commercial", "Drilling", "HSE"],
    roles: [
      { title: "Subsurface", count: 8 },
      { title: "Commercial", count: 5 },
      { title: "Operations", count: 4 },
    ],
  },
  {
    id: "cxo",
    ...
    salaryDelta: "+8%",
    metroDelta: "+8% vs metro",
    trend: [70, 76, 82, 87, 92, 95, 98, 100],
    revPerEmp: 0.9,
    ebitdaPerEmp: 0.3,
    timeToFill: "43 days",
    competition: "High",
    skills: ["Lithium Processing", "Metallurgy", "Open Pit Mining", "Maintenance", "HSE"],
    roles: [
      { title: "Processing", count: 12 },
      { title: "Mining", count: 9 },
  ...
  },
  {
    ...
    timeToFill: "43 days",
    competition: "Medium",
    skills: ["Manganese Processing", "Metallurgy", "Commercial", "Logistics", "HSE"],
    roles: [
      { title: "Commercial", count: 7 },
      { title: "Operations", count: 6 },
      { title: "Logistics", count: 4 },
    ],
  },
  {
    id: "sgq",
    ...
    salaryDelta: "+4%",
    metroDelta: "+4% vs metro",
    trend: [62, 70, 78, 85, 90, 95, 98, 100],
    revPerEmp: 0.3,
    ebitdaPerEmp: 0.1,
    timeToFill: "45 days",
    competition: "Medium",
    skills: ["Exploration", "Geology", "Project Delivery", "Studies", "Environmental"],
    roles: [
      { title: "Exploration", count: 6 },
      { title: "Geology", count: 4 },
      { title: "Studies", count: 3 },
    ],
  },
  {
    id: "del",
    ...
    timeToFill: "44 days",
    competition: "Medium",
    skills: ["Renewable Gas", "Project Delivery", "Electrical Engineering", "Commercial", "HSE"],
    roles: [
      { title: "Project Delivery", count: 9 },
      { title: "Engineering", count: 7 },
      { title: "Commercial", count: 4 },
    ],
  },
  {
    id: "asb",
    ...
    roles: [
      { title: "Fabrication & Trades", count: 88 },
      { title: "Engineering", count: 52 },
      { title: "Project Delivery", count: 34 },
    ],
  },
  {
    id: "mnd",
    ...
    roles: [
      { title: "Trades & Construction", count: 96 },
      { title: "Engineering", count: 58 },
      { title: "Maintenance", count: 44 },
    ],
  },
  {
    id: "nwh",
    ...
    timeToFill: "39 days",
    competition: "Very high",
    skills: ["Civil Construction", "Heavy Diesel", "Earthworks", "Project Delivery", "HSE"],
    roles: [
      { title: "Operators & Trades", count: 120 },
      { title: "Civil & Earthworks", count: 74 },
      { title: "Project Delivery", count: 48 },
    ],
  },
  {
    id: "mah",
    ...
    timeToFill: "39 days",
    competition: "Very high",
    skills: ["Mining Services", "Heavy Diesel", "Drill & Blast", "Maintenance", "HSE"],
    roles: [
      { title: "Operators & Trades", count: 128 },
      { title: "Maintenance", count: 66 },
      { title: "Mine Planning", count: 40 },
    ],
  },
  {
    id: "wes",
    ...
    salaryDelta: "−2%",
    metroDelta: "−2% vs metro",
    trend: [90, 92, 94, 95, 97, 98, 99, 100],
    revPerEmp: 0.4,
    ebitdaPerEmp: 0.05,
    timeToFill: "35 days",
    competition: "High",
    skills: ["Retail Operations", "Supply Chain", "Data Analytics", "Merchandising", "Finance"],
    roles: [
      { title: "Retail & Store Ops", count: 160 },
      { title: "Supply Chain", count: 96 },
      { title: "Corporate & Finance", count: 72 },
    ],
  },
  {
    id: "ccv",
    ...
    domain: "cashconverters.com",
    sector: "Consumer Finance & Retail",
    group: "Consumer and Retail",
    headcount: 1300,
    growth: 3.5,
    openRoles: 70,
    ...
    salaryDelta: "−12%",
    metroDelta: "−12% vs metro",
    trend: [91, 93, 94, 96, 97, 98, 99, 100],
    revPerEmp: 0.24,
    ebitdaPerEmp: 0.06,
    timeToFill: "33 days",
    competition: "Medium",
    ...
    roles: [
      { title: "Store & Customer Ops", count: 40 },
      { title: "Lending & Risk", count: 20 },
      { title: "Corporate", count: 12 },
    ],
  },
  {
    id: "swm",
    ...
    salaryDelta: "−8%",
    metroDelta: "−8% vs metro",
    trend: [96, 96, 97, 98, 98, 99, 99, 100],
    revPerEmp: 0.5,
    ebitdaPerEmp: 0.08,
    timeToFill: "38 days",
    competition: "Medium",
    ...
    roles: [
      { title: "Production & Editorial", count: 52 },
      { title: "Digital & Product", count: 30 },
      { title: "Sales & Commercial", count: 24 },
    ],
  },
  {
    id: "sw1",
    ...
    roles: [
      { title: "Network & Field", count: 14 },
      { title: "Software", count: 9 },
      { title: "Support", count: 6 },
    ],
  },
];
