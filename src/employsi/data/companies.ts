...
export const COMPANIES: Company[] = [
  ...
  { id: 'igo', ticker: 'IGO', name: 'IGO', domain: 'igo.com.au', sector: 'Battery Metals — Nickel & Lithium', headcount: 920, growth: 7.5, openRoles: 81, salary: '$145,000', salaryShort: '$145K', salaryNum: 145000, turnover: 12.8, salaryDelta: '+7%', metroDelta: '+7% vs metro', trend: [84, 87, 90, 92, 94, 96, 98, 100], timeToFill: '41 days', competition: 'High', skills: ['Battery Metals', 'Lithium Processing', 'Hydromet', 'Data Science', 'Sustainability'], roles: [{ title: 'Processing & Hydromet', count: 26 }, { title: 'Exploration', count: 21 }, { title: 'Corporate & ESG', count: 18 }] },
];
