...
export const STATE_STATS: Record<string, CityStat> = {
  ...
  ACT: { salary: 126, growth: 3.4, turnover: 8.4 },
};

export const CITY_STATE: Record<string, string> = {
  perth: 'WA', darwin: 'NT', adelaide: 'SA', melbourne: 'VIC', sydney: 'NSW', brisbane: 'QLD', hobart: 'TAS', canberra: 'ACT', auckland: 'NZ', wellington: 'NZ',
};
...
export const CITY_LABEL: Record<string, string> = {
  perth: 'Perth', darwin: 'Darwin', adelaide: 'Adelaide', melbourne: 'Melbourne', sydney: 'Sydney', brisbane: 'Brisbane', hobart: 'Hobart', canberra: 'Canberra', auckland: 'Auckland', wellington: 'Wellington',
};
...
export const GLOBAL_HUB_LABEL: Record<string, string> = {
  ...
  denver: 'Denver', ganzhou: 'Ganzhou', brisbane: 'Brisbane', adelaide: 'Adelaide', melbourne: 'Melbourne', sydney: 'Sydney', canberra: 'Canberra', darwin: 'Darwin', hobart: 'Hobart', auckland: 'Auckland', wellington: 'Wellington',
  ...
  bentonville: 'Bentonville', omaha: 'Omaha', indianapolis: 'Indianapolis', sandiego: 'San Diego',
  losangeles: 'Los Angeles', charlotte: 'Charlotte', minneapolis: 'Minneapolis', cincinnati: 'Cincinnati', boston: 'Boston',
  dallas: 'Dallas', washington: 'Washington DC', philadelphia: 'Philadelphia', portland: 'Portland',
  calgary: 'Calgary', montreal: 'Montreal', vancouver: 'Vancouver', ottawa: 'Ottawa',
...
export const CITY_CONTINENT: Record<string, string> = {
  ...
  bentonville: 'northamerica',
  omaha: 'northamerica',
  indianapolis: 'northamerica',
  sandiego: 'northamerica',
  losangeles: 'northamerica',
  charlotte: 'northamerica',
  minneapolis: 'northamerica',
  cincinnati: 'northamerica',
  boston: 'northamerica',
  dallas: 'northamerica',
  washington: 'northamerica',
  philadelphia: 'northamerica',
  portland: 'northamerica',
  calgary: 'northamerica',
  montreal: 'northamerica',
...
export const GLOBAL_STATS: Record<string, CityStat> = {
  ...
  bentonville: { salary: 108, growth: 4.8, turnover: 10.5 },
  omaha: { salary: 112, growth: 3.4, turnover: 9.8 },
  indianapolis: { salary: 114, growth: 3.8, turnover: 10.4 },
  sandiego: { salary: 138, growth: 4.0, turnover: 11.2 },
  losangeles: { salary: 142, growth: 3.2, turnover: 11.8 },
  charlotte: { salary: 126, growth: 4.4, turnover: 10.6 },
  minneapolis: { salary: 128, growth: 3.0, turnover: 9.6 },
  cincinnati: { salary: 116, growth: 2.8, turnover: 10.0 },
  boston: { salary: 158, growth: 3.6, turnover: 10.8 },
  dallas: { salary: 120, growth: 4.6, turnover: 11.0 },
  washington: { salary: 140, growth: 3.0, turnover: 10.0 },
  philadelphia: { salary: 118, growth: 2.8, turnover: 10.2 },
  portland: { salary: 124, growth: 3.4, turnover: 10.6 },
  calgary: { salary: 118, growth: 4.0, turnover: 10.5 },
  montreal: { salary: 108, growth: 3.2, turnover: 9.5 },
  vancouver: { salary: 116, growth: 3.6, turnover: 10.0 },
  ottawa: { salary: 112, growth: 3.0, turnover: 9.2 },
  ...
  wellington: { salary: 95, growth: 2.6, turnover: 9.6 },
