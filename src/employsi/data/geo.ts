...
export const GLOBAL_STATS: Record<string, CityStat> = {
  ...
  // San Jose/Silicon Valley: the highest-paying US metro in the roster, and more
  // concentrated in technology than San Francisco now that the hardware and
  // semiconductor names sit here rather than in the city.
  sanjose: { salary: 195, growth: 4.2, turnover: 13.0 },
