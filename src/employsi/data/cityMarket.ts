...
export const CITY_MARKET: Record<string, CityMarket> = {
  ...
  seattle: {
    country: "us",
    where: "Seattle",
    region: /united states|\busa?\b|seattle|washington/i,
  },
  newyork: { country: "us", where: "New York", region: /united states|\busa?\b|new york|\bny\b/i },
  sanfrancisco: {
    country: "us",
    where: "San Francisco",
    region: /united states|\busa?\b|san francisco|california|bay area/i,
  },
  // Silicon Valley towns spelled out: a Cupertino or Mountain View posting reads
  // as neither 'San Jose' nor 'San Francisco', so match the valley by name.
  sanjose: {
    country: "us",
    where: "San Jose",
    region:
      /united states|\busa?\b|san jose|santa clara|sunnyvale|cupertino|mountain view|palo alto|milpitas|los gatos|silicon valley|california/i,
  },
  ...
  bentonville: {
    country: "us",
    where: "Bentonville",
    region: /united states|\busa?\b|bentonville|arkansas/i,
  },
  omaha: { country: "us", where: "Omaha", region: /united states|\busa?\b|omaha|nebraska/i },
  indianapolis: {
    country: "us",
    where: "Indianapolis",
    region: /united states|\busa?\b|indianapolis|indiana/i,
  },
  sandiego: {
    country: "us",
    where: "San Diego",
    region: /united states|\busa?\b|san diego|california/i,
  },
  losangeles: {
    country: "us",
    where: "Los Angeles",
    region: /united states|\busa?\b|los angeles|california/i,
  },
  charlotte: {
    country: "us",
    where: "Charlotte",
    region: /united states|\busa?\b|charlotte|north carolina/i,
  },
  minneapolis: {
    country: "us",
    where: "Minneapolis",
    region: /united states|\busa?\b|minneapolis|minnesota/i,
  },
  cincinnati: {
    country: "us",
    where: "Cincinnati",
    region: /united states|\busa?\b|cincinnati|ohio/i,
  },
  boston: {
    country: "us",
    where: "Boston",
    region: /united states|\busa?\b|boston|massachusetts/i,
  },
  dallas: {
    country: "us",
    where: "Dallas",
    region: /united states|\busa?\b|dallas|fort worth|texas/i,
  },
  washington: {
    country: "us",
    where: "Washington DC",
    region: /united states|\busa?\b|washington|district of columbia|\bdc\b/i,
  },
  philadelphia: {
    country: "us",
    where: "Philadelphia",
    region: /united states|\busa?\b|philadelphia|pennsylvania/i,
  },
  ...
  johannesburg: {
    country: "za",
    where: "Johannesburg",
    region: /south africa|johannesburg|gauteng/i,
  },
