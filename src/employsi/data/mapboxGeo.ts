...
export const CITY_VIEWS: Record<string, CityView> = {
  ...
  minneapolis: { center: [-93.2650, 44.9778], zoom: 16.3, pitch: 60, bearing: -16 },
  cincinnati: { center: [-84.5120, 39.1031], zoom: 16.3, pitch: 60, bearing: -15 },
  boston: { center: [-71.0589, 42.3601], zoom: 16.4, pitch: 60, bearing: -18 },
  dallas: { center: [-96.7970, 32.7767], zoom: 16.3, pitch: 60, bearing: -15 },
