...
const EVENT_ICONS: Record<string, ReactNode> = {
  ...
  bitcoin: svg(
    <>
      ...
      <path d="M9.6 8h3.9a2 2 0 0 1 0 4H9.6Zm0 4h4.2a2 2 0 0 1 0 4H9.6Z" />
      <path d="M10.7 6.4v11.2M13 6.4V8M13 16v1.6" />
    </>,
  ),
  pickaxe: svg(
    <>
      <path d="M14 4c2.2 0 5.2 2 6.2 6" />
      <path d="M14 4C11.8 4 8.8 6 7.8 10" />
      <path d="M11 9 4 20" />
    </>,
  ),
  ...
  virus: svg(
    <>
      ...
      <path d="M12 3.2v2.6M12 18.2v2.6M3.2 12h2.6M18.2 12h2.6M6 6l1.7 1.7M16.3 16.3 18 18M18 6l-1.7 1.7M7.7 16.3 6 18" />
    </>,
  ),
  boom: svg(
    <>
  ...
  ai: svg(
    <>
      ...
      <path d="M12 3v2M12 19v2M3 12h2M19 12h2M9 3.4v1.6M15 3.4v1.6M9 19v1.6M15 19v1.6M3.4 9H5M3.4 15H5M19 9h1.6M19 15h1.6" />
    </>,
  ),
};
          ...
          {(() => {
            ...
            return ev ? (
              <div className="hktimeevent">
                <span className="hktimeicon" aria-hidden="true">
                  {EVENT_ICONS[ev.icon]}
                </span>
                {ev.label}
              </div>
