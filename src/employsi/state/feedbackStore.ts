...
const SEED: FeedbackItem[] = [
  {
    id: "s1",
    title: "Add Brisbane and Adelaide employers to the local city map",
    author: "Priya S.",
    votes: 128,
    status: "planned",
    ts: Date.parse("2026-05-02"),
  },
  {
    id: "s2",
    title: "Export salary + headcount benchmarks to CSV",
    author: "Marcus T.",
    votes: 94,
    status: "under-review",
    ts: Date.parse("2026-05-19"),
  },
  {
    id: "s3",
    title: "Compare more than two companies side by side",
    author: "Dana W.",
    votes: 76,
    status: "open",
  ...
  {
    id: "s4",
    title: "Email alerts when a followed company opens new roles",
    author: "Leah K.",
    votes: 61,
    status: "planned",
    ts: Date.parse("2026-06-08"),
  },
  {
    id: "s5",
    title: "Filter companies by graduate-program intake",
    author: "Sam O.",
    votes: 47,
    status: "open",
    ts: Date.parse("2026-06-14"),
  },
  {
    id: "s6",
    title: "A full dark mode for the whole app, not just the map",
    author: "Chris R.",
    votes: 39,
    status: "under-review",
    ts: Date.parse("2026-06-21"),
  },
  {
    id: "s7",
    title: "Show visa-sponsorship availability on the company card",
    author: "Nadia F.",
    votes: 33,
    status: "open",
    ts: Date.parse("2026-06-27"),
  },
  {
    id: "s8",
    title: "Live share-price ticker across all listed companies",
    author: "Employsi",
    votes: 58,
    status: "shipped",
    ts: Date.parse("2026-04-11"),
  },
];
